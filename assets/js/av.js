...
var _ = __webpack_require__(0);
var Promise = __webpack_require__(1);
var localStorage = __webpack_require__(28);
...
AV.Conversation = __webpack_require__(57);
...
var comments = ["Browser" || 'Node.js'].concat(__webpack_require__(18));
...
var AV = __webpack_require__(5);
var AppRouter = __webpack_require__(31);
...
var parseBase64 = __webpack_require__(44);
...
(function(){
  var crypt = __webpack_require__(42),
...
module.exports = function (AV) {
  ...
  /** @lends AV.User.prototype */{
    ...
    _linkWith: function _linkWith(provider, data) {
      ...
      var _ref3 = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {},
          _ref3$failOnNotExist = _ref3.failOnNotExist,
          failOnNotExist = _ref3$failOnNotExist === undefined ? false : _ref3$failOnNotExist;
    ...
    loginWithWeapp: function loginWithWeapp(options) {
      ...
      return getWeappLoginCode().then(function (code) {
        return _this3.loginWithAuthData({ code: code }, 'lc_weapp', options);
      });
    },
  ...
  /** @lends AV.User */{
    ...
    loginWithWeapp: function loginWithWeapp(options) {
      ...
      return getWeappLoginCode().then(function (code) {
        return _this6.loginWithAuthData({ code: code }, 'lc_weapp', options);
      });
    },
